...
function getJobListingHTML(jobData, filterTags = []) {
    ...
    let jobListingHTML = `
        <div class="${jobData.postedAt === "1d ago" ? "featured" : ""} jobs__item">
            <div class="jobs__column jobs__column--left">
                ...
                <div class="jobs__info">
                    ...
                    <span>${jobData.postedAt === "1d ago" || jobData.postedAt === "2d ago" ? "<small class='new badge'>NEW!</small>" : ""}</span>
                    <span>${jobData.postedAt === "1d ago" ? "<small class='feature badge'>FEATURED</small>" : ""}</span>
